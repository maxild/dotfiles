...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(
     ...
     themes-megapack
     yaml
     ;; "haskell-completion-backend 'lsp" is the default, when lsp layer is used
