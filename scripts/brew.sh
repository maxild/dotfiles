...
# running `chsh` (See http://apple.stackexchange.com/questions/24632/is-it-safe-to-upgrade-bash-via-homebrew).
# Change default shell by running: chsh -s /usr/local/bin/bash
brew install bash
